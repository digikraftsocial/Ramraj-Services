            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="feature-one__image">
                        <img src="<?php echo base_url(); ?>assets/images/resources/feature-1-1.jpg" alt="">
            ...
            <div class="row">
                <div class="col-md-12 col-lg-4">
                    <div class="service-one__box">
                        <img src="<?php echo base_url(); ?>assets/images/services/service-1-1.jpg" alt="">
                        <div class="service-one__box-content">
                            <h3><a href="<?php echo base_url('Services/servicedetails'); ?>">Agriculture Leader</a></h3>
                        </div><!-- /.service-one__box-content -->
                    </div><!-- /.service-one__box -->
                </div><!-- /.col-md-12 col-lg-4 -->
                <div class="col-md-12 col-lg-4">
                    <div class="service-one__box">
                        <img src="<?php echo base_url(); ?>assets/images/services/service-1-2.jpg" alt="">
                        <div class="service-one__box-content">
                            <h3><a href="<?php echo base_url('Services/servicedetails'); ?>">Quality Standards</a></h3>
                        </div><!-- /.service-one__box-content -->
                    </div><!-- /.service-one__box -->
                </div><!-- /.col-md-12 col-lg-4 -->
                <div class="col-md-12 col-lg-4">
                    <div class="service-one__box">
                        <img src="<?php echo base_url(); ?>assets/images/services/service-1-3.jpg" alt="">
                        <div class="service-one__box-content">
                            <h3><a href="<?php echo base_url('Services/servicedetails'); ?>">Organic Services</a></h3>
                        </div><!-- /.service-one__box-content -->
                    </div><!-- /.service-one__box -->
                </div><!-- /.col-md-12 col-lg-4 -->
            </div><!-- /.row -->
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="call-to-action__three-image">
                        <img src="<?php echo base_url(); ?>assets/images/resources/cta-3-1.jpg" alt="">
                        <img src="<?php echo base_url(); ?>assets/images/resources/cta-3-2.jpg" alt="">
